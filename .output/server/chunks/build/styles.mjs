...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.1-D6WKP8.mjs').then(interopDefault),
  ...
  "app.vue?vue&type=style&index=0&lang.scss": () => import('./app-styles.CCM3FoVi.mjs').then(interopDefault)
};
