                ...
                <div>
                  ...
                  >
                    <SwiperSlide v-for="n in backnumberInfo[currentYear][1]" :key="n">
                      ...
                      <img class="gallery__overlayImage slide-in" :src="'https://raw.githubusercontent.com/zikumanage/jaico_gallery/git_public/assets/images/backnumber/'+backnumberInfo[currentYear][0]+'_0'+n+'.jpg'">
                    </SwiperSlide>
                </Swiper>
                <Swiper
                  ...
                  <SwiperSlide v-for="n in backnumberInfo[currentYear][1]" :key="n">
                    <a @click="isOverlayDisplay = !isOverlayDisplay">
                      ...
                      <img :src="'https://raw.githubusercontent.com/zikumanage/jaico_gallery/git_public/assets/images/backnumber/'+backnumberInfo[currentYear][0]+'_0'+n+'.jpg'">
                    </a>
                  </SwiperSlide>
                </Swiper>
                </div>
